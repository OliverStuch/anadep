...
import org.anadep.analysis.Analyser;
import org.anadep.model.jung.DependencyGraphJungAdaptor;
...
public class JungGraphApplet extends JApplet {
     ...
     * 
     */
    public JungGraphApplet() {
	Analyser analyser = new Analyser(new File("/home/os/.m2/repository/org/anadep"));
//	Analyser analyser = new Analyser(new File("../anadep-core/src/test/testres/auslieferung"));

        graph = ((DependencyGraphJungAdaptor)(analyser.createComponentDependencyGraph())).dependencyGraph();
        
        graphLayout = new CircleLayout<String,Number>(graph);
